      ...
      div([
        ...
        div([
          ...
          p([
            ...
            ' slowly (pun intended) grow towards a footprint of 5 megabytes.',
          ]),
          p(
            'as the sarcastic remark might demonstrate, we think that all of that bloat is insane.',
          ),
          p([
            'magic has one external client side dependency,',
            Link({ to: 'https://github.com/jorgebucharan/hyperapp' }, 'hyperapp'),
            ", with it's ~400 lines. thats it.",
          ]),
