...
const c = { a: ['a', 'b', 'c', 'd', 'e'], b: ['aa', 'bb', 'cc', 'dd', 'ee', 'ff'], c: ['aa', 'bb', 'dd'] }

export default [
  { fn: uniqueMerge(a, b), expect: is.objectNative, info: 'uniqueMerge returns an array' },
  { fn: uniqueMerge(a, undefined), expect: is.deep.equal(a), info: 'uniqueMerge returns a if b is falsy' },
  { fn: uniqueMerge(undefined, b), expect: is.deep.equal(b), info: 'uniqueMerge returns b if a is falsy' },
